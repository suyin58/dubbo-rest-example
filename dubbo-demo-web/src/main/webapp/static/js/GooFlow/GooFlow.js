...
//初始化区域图的对象
	...
	if(property.haveHead){
		...
		+"><label title='"+(property.initLabelText||"newFlow_1")+"' "
	...
	if(property.haveTool){
		...
		//未加代码：加入绘图工具按钮
		this.$tool.append("<a href='javascript:void(0)' type='cursor' class='GooFlow_tool_btndown' id='"+this.$id+"_btn_cursor'><i class='ico_cursor'/></a><a href='javascript:void(0)' type='direct' class='GooFlow_tool_btn' id='"+this.$id+"_btn_direct'><i class='ico_direct'/></a>");
	...
	this.$workArea=$("<div class='GooFlow_work_inner' style='width:"+width*0.98+"px;height:"+height*1.2+"px'></div>")
